  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col bg-[#f2f2f2]">
      <header className="mx-auto w-full max-w-[560px] px-5 pt-12 pb-6 sm:px-6 sm:pt-16 sm:pb-8">
        <p className="text-[15px] font-semibold text-[#e45b4c] sm:text-sm">가계부</p>
        <h1 className="mt-2 text-[1.75rem] font-bold leading-tight tracking-tight text-[#222] sm:text-[2rem]">
          AI 가계부
        </h1>
